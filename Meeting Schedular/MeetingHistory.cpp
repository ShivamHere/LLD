...
public:
    ...
    void showMeetingDetails(){
        cout<<"Room: "<<room<<" Start: "<<slot.getStartTime()<<" End: "<<slot.getEndTime()<<endl;
    }
};
...
public:
    ...
    Calendar getCalendar() const { return calendar; }
};
...
public:
    ...
    Meetings getMeetings() const {  return meetings; } 
...
int main(){
    ...
    cout<<Schedular.BookMeeting(s1)<<endl;
    Meetings History = Schedular.getMeetings();
    for(Meeting meeting : History)
